...
p. Please see "./examples/":https://github.com/gocom/mck_login/tree/master/examples directory for usage instructions and examples. The plugin's source includes documentation (PHPdoc) and outlines all tag attributes and has embedded minimal inline-examples too.
